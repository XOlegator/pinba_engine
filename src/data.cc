...
void pinba_update_tag_info_add(size_t request_id, void *rep,
...
void pinba_update_tag_info_delete(size_t request_id, void *rep,
                                  const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tag_info_data *data;
...
void pinba_update_tag2_info_add(size_t request_id, void *rep,
                                const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
...
void pinba_update_tag2_info_delete(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tag2_info_data *data;
...
void pinba_update_tag_report_add(size_t request_id, void *rep,
                                 const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
...
void pinba_update_tag_report_delete(size_t request_id, void *rep,
                                    const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tag_report_data *data;
...
void pinba_update_tag2_report_add(size_t request_id, void *rep,
                                  const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
...
void pinba_update_tag2_report_delete(size_t request_id, void *rep,
                                     const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tag2_report_data *data;
...
void pinba_update_tag_report2_add(size_t request_id, void *rep,
                                  const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  ...
  for (i = 0; i < record->timers_cnt; i++) {
    ...
    index[index_len] = '|';
    index_len++;
    memcat_static(index, index_len, record->data.server_name, (int)record->data.server_name_len,
                  index_len);
    index[index_len] = '|';
    index_len++;
...
void pinba_update_tag_report2_delete(size_t request_id, void *rep,
                                     const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tag_report2_data *data;
  ...
  char index[PINBA_HOSTNAME_SIZE + 1 + PINBA_SERVER_NAME_SIZE + 1 + PINBA_SCRIPT_NAME_SIZE + 1 +
             PINBA_TAG_VALUE_SIZE];
  pinba_word *word;
  void *script_map;
...
void pinba_update_tag2_report2_add(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  ...
  for (i = 0; i < record->timers_cnt; i++) {
    ...
    memcat_static(index_val, index_len, record->data.server_name, (int)record->data.server_name_len,
                  index_len);
    pinba_append_key_delimiter(index_val, sizeof(index_val), &index_len);
...
void pinba_update_tag2_report2_delete(size_t request_id, void *rep,
                                      const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tag2_report2_data *data;
  ...
  int i, j, tag1_pos, tag2_pos;
  int index_len;
  char index_val[PINBA_HOSTNAME_SIZE + PINBA_SERVER_NAME_SIZE + PINBA_SCRIPT_NAME_SIZE + 1 +
                 PINBA_TAG_VALUE_SIZE + 1 + PINBA_TAG_VALUE_SIZE + 1]; /* +1 for safety */
  pinba_word *word1, *word2;
  void *script_map;
...
void pinba_update_tagN_info_add(size_t request_id, void *rep,
                                const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
...
void pinba_update_tagN_info_delete(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tagN_info_data *data;
...
void pinba_update_tagN_report_add(size_t request_id, void *rep,
                                  const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
...
void pinba_update_tagN_report_delete(size_t request_id, void *rep,
                                     const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tagN_report_data *data;
...
void pinba_update_tagN_report2_add(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
...
void pinba_update_tagN_report2_delete(size_t request_id, void *rep,
                                      const pinba_stats_record *record) /* {{{ */
{
  pinba_tag_report *report = (pinba_tag_report *)rep;
  struct pinba_tagN_report2_data *data;
...
void pinba_update_rtag_info_add(size_t request_id, void *rep,
                                const pinba_stats_record *record) /* {{{ */
{
...
void pinba_update_rtag_info_delete(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtag2_info_add(size_t request_id, void *rep,
                                 const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtag2_info_delete(size_t request_id, void *rep,
                                    const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtagN_info_add(size_t request_id, void *rep,
                                 const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtagN_info_delete(size_t request_id, void *rep,
                                    const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtag_report_add(size_t request_id, void *rep,
                                  const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtag_report_delete(size_t request_id, void *rep,
                                     const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtag2_report_add(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtag2_report_delete(size_t request_id, void *rep,
                                      const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtagN_report_add(size_t request_id, void *rep,
                                   const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_rtagN_report_delete(size_t request_id, void *rep,
                                      const pinba_stats_record *record) /* {{{ */
{
  (void)request_id; /* Suppress unused parameter warning */
  pinba_rtag_report *report = (pinba_rtag_report *)rep;
...
void pinba_update_add(pinba_array_t *array, size_t request_id,
                      const pinba_stats_record *record) /* {{{ */
{
...
void pinba_update_delete(pinba_array_t *array, size_t request_id,
                         const pinba_stats_record *record) /* {{{ */
{
  pinba_std_report *report;
  unsigned int i;
