...
typedef enum {
  ...
  PINBA_TABLE_TAG_REPORT2,  /* tag report grouped by script_name, host_name, server_name and custom
                               tag */
  PINBA_TABLE_TAG2_REPORT2, /* tag report grouped by script_name, host_name, server_name and 2
                               custom tags */
  PINBA_TABLE_TAGN_REPORT2, /* tag report grouped by script_name, host_name, server_name and N
                               custom tags */
...
typedef void(pinba_report_update_function)(size_t request_id, void *report,
...
typedef void(pinba_rtag_report_update_function)(size_t request_id, pinba_rtag_report *report,
                                                const pinba_stats_record *record);
